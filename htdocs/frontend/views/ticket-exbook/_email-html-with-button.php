                                                    ...
                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th style="Margin:0;color:#000;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                ...
                                                                <h1 id="marked" class="text-center" style="Margin:0;Margin-bottom:10px;background-color:#E7FF47;color:inherit;font-family:Helvetica,Arial,sans-serif;font-size:2em;font-weight:600;line-height:1.3;margin:0 auto;margin-bottom:10px;padding:3px 7px;text-align:center;width:320px;word-wrap:normal">BOOK REPORT</h1>
                                                                <table class="spacer" style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                    <tbody>
                                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                                            <td height="25px" style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#000;font-family:Helvetica,Arial,sans-serif;font-size:25px;font-weight:400;hyphens:auto;line-height:25px;margin:0;mso-line-height-rule:exactly;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">&#xA0;</td>
                                                                ...
                                                                <p id="title" style="Margin:0;Margin-bottom:10px;color:#FF5C48;font-family:Helvetica,Arial,sans-serif;font-size:2em;font-weight:400;line-height:1.1em;margin:5px 0;margin-bottom:10px;padding:0;text-align:left"><?= $model->title . '<a href="http://londonliteraryscouting.com/book/'.$model->slug.'" style="Margin:0 0 0 15px;border:0 solid #ff5c48;border-radius:3px;color:#2e2d2e;display:inline-block;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:700;line-height:0.9;margin:0 0 0 15px;padding:8px;background-color:#ff5c48;text-align:left;text-decoration:none">view in web</a>'; ?></p>
                                                                ...
                                                                <?php endif; ?>
                                                                <p id="categories" style="Margin:0;Margin-bottom:10px;background-color:#E7FF47;color:#000;display:inline-flex;font-family:Helvetica,Arial,sans-serif;font-size:.9em;font-weight:700;line-height:1.3;margin:0;margin-bottom:10px;padding:3px 7px;text-align:left"><?= (isset($model->category->name) ? $model->category->name : false); ?><?= (!empty($model->otherCategories) ?  $model->otherCategories  : false); ?></p>
                                                                <p id="submission" style="Margin:0;Margin-bottom:10px;color:#02d802;font-family:'Roboto Slab',serif;font-size:.9em;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left"><?= $model->submission . " - " . Yii::$app->formatter->asDate($model->updated_at, 'dd MMM yyyy'); ?></p>
                                                                                            ...
                                                                                            <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                                <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                                    ...
                                                                                                    <?php if (!empty($model->length)): ?>
                                                                                                        <p style="Margin:0;Margin-bottom:10px;color:#000;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left"><strong>Lenght</strong>
